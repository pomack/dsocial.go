...
func TestInitialSyncWithEmptyDataStoreWithGoogleContacts(t *testing.T) {
    ...
    ds.SetContactsServiceSettings(csSettings)
    csSettings2 := contacts.NewGoogleContactServiceSettings()
    csSettings2.SetDsocialUserId(dsocialUserId)
    csSettings2.SetClientProperties(make(jsonhelper.JSONObject))
    csSettings2.SetExternalUserId("test2@example.com")
